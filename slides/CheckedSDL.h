...
extern DECLSPEC SDL_Window * SDLCALL SDL_CreateWindow(TH(main),
                                                      const char *title,
                                                      int x, int y, int w,
                                                      int h, Uint32 flags);
...
extern DECLSPEC SDL_Texture * SDLCALL SDL_CreateTextureFromSurface(TH(main), SDL_Renderer * renderer, SDL_Surface * surface);

extern DECLSPEC SDL_Renderer * SDLCALL SDL_CreateRenderer(TH(main),
                                               SDL_Window * window,
...
extern DECLSPEC int SDLCALL SDL_RenderCopy(TH(main),
